...
new_train_folder = '../MVTEC-AD-Spectrograms/STFT/new_train_S_STFT'
new_test_folder = '../MVTEC-AD-Spectrograms/STFT/new_test_S_STFT'
...
class ViTModel(LightningModule):
    def __init__(self):
        ...
        self.model = timm.create_model('tf_efficientnet_b7_ns', pretrained=True, num_classes=2)
