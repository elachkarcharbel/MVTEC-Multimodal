...
class RawNet(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.conv1 = nn.Conv1d(1, 64, kernel_size=11, stride=2, padding=5)  # Larger kernel & stride
        ...
        self.relu = nn.ReLU()
        self.pool = nn.AdaptiveAvgPool1d(8)  # Reduce to 8 features per channel

        self.fc = nn.Linear(512 * 8, num_classes)  # Fully connected layer
...
class RawNetModel(LightningModule):
    def __init__(self):
